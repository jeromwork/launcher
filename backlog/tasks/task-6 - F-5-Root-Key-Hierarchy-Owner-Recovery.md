...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Зашёл через Google + ввёл пароль на новом устройстве — конфигурация и контакты восстановились
- [ ] #2 Забыл пароль — увидел экран Fallback, могу начать с чистого листа без потери Google-аккаунта
- [ ] #3 Huawei без Google-сервисов — приложение работает в локальном режиме, не падает при попытке cloud-фичи
- [ ] #4 Перешёл с одного устройства на другое (миграция со старого варианта шифрования) — старые зашифрованные данные читаются без потерь
- [ ] #5 Android Autofill подхватывает мой пароль автоматически (не нужно вводить каждый раз)
- [ ] #6 Документация recovery-flow.md написана простым русским, бабушка-админ может прочитать и понять
<!-- AC:END -->
