...
<!-- SECTION:HISTORICAL_REPRODUCTION:BEGIN -->
## Historical Reproduction Notes (2026-06-28, pre-fix)

> Записано до реализации фикса. Сохранено для архива и для side-findings, которые ушли в отдельные follow-up задачи.
...
<!-- SECTION:HISTORICAL_REPRODUCTION:END -->
