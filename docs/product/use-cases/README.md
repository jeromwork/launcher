...
- **`docs/product/feature-priorities.md`, `senior-safe-launcher-plan.md`** — исторические артефакты, частично актуальны. Use-case документы реструктурируют их содержание под современный контекст. (Старый `roadmap.md` удалён 2026-06-23: стратегия → `docs/product/vision.md`, операционный план → `backlog overview`.)
