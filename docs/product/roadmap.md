...
### Spec 015 — `symmetric-pairing-bidirectional-control` *(добавлен 2026-05-21, выделен из 011)*

**Статус:** backlog (без stub-файла).

**Зависит от:** 011 (per-device key pairs + e2e infrastructure уже введены).

**Контекст переноса (2026-05-21):** в clarify-сессии спека 011 (см. [specs/011-contacts-and-e2e-encrypted-media/spec.md](../../specs/011-contacts-and-e2e-encrypted-media/spec.md) §Clarifications C-1) обсуждалось «два телефона равноценны, оба могут управлять друг другом». В 011 решено оставить одностороннюю модель из спеков 7-9, а двусторонний pairing вынести отдельным спеком. Crypto-инфраструктура 011 уже membership-agnostic — этот спек добавляет только management-permission и UX.
...
### Spec 016 — `family-group-shared-encryption` *(добавлен 2026-05-21, выделен из 011)*
...
### Spec 017 — `multi-device-recovery` *(добавлен 2026-05-21, выделен из 011)*
...
### Spec 018 — `key-rotation-forward-secrecy` *(добавлен 2026-05-21, выделен из 011)*
