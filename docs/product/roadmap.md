...
| 009 | `admin-mode-flows` | Не начат (был 008) | 008 |
| 010 | `setup-assistant-soft-checks` | Не начат (был 009) | 006 (параллельно 007/008) |
...
### Spec 004 — `ui-stack-migration` *(NEW, per ADR-005)*
