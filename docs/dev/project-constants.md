...
**Правило**: настройка Simple Launcher НЕ привязана к admin'скому telefon'у. Доступна:

1. **Локально на телефоне бабушки** — через 7-tap → challenge gate → edit mode.
...
- Не предлагать «бабушка не может настраивать сама» — может, через 7-tap.
