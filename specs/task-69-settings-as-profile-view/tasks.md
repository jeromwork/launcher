...
- [ ] **T069-020** Dangling-ref audit of legacy `SettingsScreen` (`SettingsComponent` nav, spec-009 admin-mode entry, any `docs/**`/`specs/**`). Output: list of call sites to migrate. Trace: FR-017, CHK012. Requires: —.
