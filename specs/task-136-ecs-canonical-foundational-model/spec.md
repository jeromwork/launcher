...
**Input**: TASK-136 Decision block (2026-07-18) — canonical ECS (composition) supersedes the tagged-component discriminated-union model of TASK-120/127 ([ADR-012](../../docs/adr/ADR-012-tagged-component-model-vs-canonical-ecs.md)).
**Supersedes**: TASK-120, TASK-127, [ADR-012](../../docs/adr/ADR-012-tagged-component-model-vs-canonical-ecs.md).
...
- TASK-120/127 построили модель, которую владелец назвал «tagged-component, ECS-inspired» ([ADR-012](../../docs/adr/ADR-012-tagged-component-model-vs-canonical-ecs.md)). Её текущее состояние в коде:
...
- **FR-018** (ADR): MUST быть написан **ADR-013** (canonical ECS adopted — разворачивает [ADR-012](../../docs/adr/ADR-012-tagged-component-model-vs-canonical-ecs.md) по двум основаниям: реальная composition-нужда admin-lock + pre-release timing). `ADR-012` MUST получить header «Superseded by ADR-013» (файл остаётся как история, rule 11).
