 ...
 *  • `iosMain` — stub-screamer; throws [family.crypto.exception.CryptoException.NotImplementedOnIos]
...
expect class SecureKeyStore(context: KeyStoreContext) {
     ...
     *
     * @throws family.crypto.exception.CryptoException.KeystoreUnavailable if TEE not available.
     * @throws family.crypto.exception.CryptoException.KeystoreInvalidated if the wrap-key
