...
interface EncryptedMediaStorage {
    /** @throws cryptokit.crypto.exception.CryptoException on upload / serialization failure. */
    suspend fun upload(linkId: String, uuid: Uuid, envelope: EncryptedEnvelope)

    /** @throws cryptokit.crypto.exception.CryptoException on download / deserialization failure. */
    suspend fun download(linkId: String, uuid: Uuid): EncryptedEnvelope

    /** @throws cryptokit.crypto.exception.CryptoException on delete failure. */
