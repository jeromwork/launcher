...
interface AeadCipher {
     ...
     * @throws cryptokit.crypto.exception.CryptoException.RandomSourceUnavailable if entropy fails.
     */
    suspend fun encrypt(
        plaintext: ByteArray,
        key: ByteArray,
    ...
    /**
     * @throws cryptokit.crypto.exception.CryptoException.DecryptionFailed on MAC mismatch
     *   (corruption, tampering, wrong key).
     * @throws cryptokit.crypto.exception.CryptoException.MalformedCiphertext if envelope structure invalid.
     */
    suspend fun decrypt(
