 ...
 * itself is delegated to [keyDerivation] (default impl is [family.crypto.libsodium.LibsodiumKeyDerivation]).
 *
 ...
 *
 * **StrongBox**: handled transparently by the underlying [family.crypto.api.SecureKeyStore]
 * (see [family.crypto.SecureKeyStore.android.kt]). The registry itself does not
