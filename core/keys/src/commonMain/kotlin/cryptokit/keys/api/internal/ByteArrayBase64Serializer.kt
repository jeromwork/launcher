 ...
 * ([cryptokit.keys.api.SealedConfig], [cryptokit.keys.api.RecoveryKeyBackupBlob],
 * [cryptokit.keys.api.WrappedDek]).
 *
 * Скопирован из `:core:crypto/.../ByteArrayBase64Serializer.kt` (internal там)
 * чтобы избежать cross-module internal API exposure. RFC 4648 §4 с padding.
 *
 * TODO(refactor-when-3rd-consumer): см. Outcome.kt / AuthIdentity.kt — extract
 * в slim `:core:common`.
 */
internal object ByteArrayBase64Serializer : KSerializer<ByteArray> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("cryptokit.keys.ByteArrayBase64", PrimitiveKind.STRING)
