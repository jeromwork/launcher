...
import cryptokit.keys.api.RootKeyManager
 ...
 * ([cryptokit.keys.api.ConfigSaver.saveForOther], [cryptokit.keys.api.RemoteStorage]).
 * That layer routes per-grant access through [cryptokit.keys.api.internal.RecipientResolver]
