 ...
 * an identical Base64 codec. Serial descriptor name is stack-wide (`family.ByteArrayBase64`),
...
object ByteArrayBase64Serializer : KSerializer<ByteArray> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("family.ByteArrayBase64", PrimitiveKind.STRING)
