...
interface DeviceIdentityRepository {
    /** @throws family.crypto.exception.CryptoException on serialization / network failure. */
    suspend fun publishOwn(linkId: String, identity: DeviceIdentity)

    /** @throws family.crypto.exception.CryptoException on signature verify fail or document missing. */
